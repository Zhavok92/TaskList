...
adb shell am start -n com.cypetech.TaskList/org.qtproject.qt.android.bindings.QtActivity

:MyLabel
for /f "delims=" %%a in ('adb shell pidof com.cypetech.TaskList') do set pid=%%a
if "%pid%"=="" goto MyLabel
